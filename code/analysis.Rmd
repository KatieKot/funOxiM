...
# Simple enrichment using Fisher's exac test. This part uses CpG level file 
# with coverages. 
...
```{r}
# Figure 4C and 4D. Fraction and expression based on TE possition. 
